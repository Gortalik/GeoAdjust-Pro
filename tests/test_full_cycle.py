...
def test_adjustment_engine():
    ...
    print(f"[OK] Создано {len(observations)} наблюдений")
...
def main():
    ...
    # Тест SDR файлов
    sdr_files = [
        'test_real_mes/k/kotlntss06042026.sdr',
        'test_real_mes/n_g/plan/gro2908_const.sdr',
        'test_real_mes/p_l_g/plan/grocenter (1)_const.sdr',
        'test_real_mes/k_n/plan/ntsskotl06022026_const.sdr',
        'test_real_mes/b_g/plan/badgro16093_const.sdr',
        'test_real_mes/b_o/plan/badokr_const.sdr',
    ]
    ...
    # Тест GSI файлов
    gsi_files = [
        'test_real_mes/n_g/niv/GRO0109.GSI',
        'test_real_mes/p_l_g/niv/GRO0509.GSI',
        'test_real_mes/d_d_k/niv/KOL0708.GSI',
        'test_real_mes/b_g/niv/GRO2209.GSI',
        'test_real_mes/s5/niv/DOM0112 (1).GSI',
        'test_real_mes/s5/niv/MIR0212.GSI',
        'test_real_mes/d_d_o/niv/DAY1302.GSI',
    ]
    ...
    # Тест DAT файлов
    dat_files = [
        'test_real_mes/s_b/niv/BOT12210.DAT',
        'test_real_mes/s_b2/niv/BOT22110.DAT',
        'test_real_mes/l/niv/LIH2103.DAT',
    ]
